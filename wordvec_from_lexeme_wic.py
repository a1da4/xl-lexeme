...
def main(data_dir: str, data_type: str) -> None:
    ...
    for target_word in tqdm(target_words):
        ...
        target_sentences = collect_usage(target_word, file_path)
        ...
        for sentence in tqdm(target_sentences, desc=f"[obtain {target_word}'s vectors...]"):
            all_positions = find_multiple_positions_token(sentence, target_word)
    ...
    pickle.dump(word2vec, open(f"lexeme_{file_path}.pkl", "wb"))
    """
